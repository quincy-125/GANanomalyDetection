...
#data_dir = '/research/bsi/projects/PI/tertiary/Hart_Steven_m087494/s211408.DigitalPathology/Code/GANanomalyDetection/datasets'
...
# Dataset (choose one).
desc += '-custom';            dataset = EasyDict(tfrecord_dir=data_dir); train.mirror_augment = False
...
desc += '-preset-v1-1gpu'; num_gpus = 1; D.mbstd_group_size = 16; sched.minibatch_base = 16; sched.minibatch_dict = {4: 16, 8: 16, 16: 16, 32: 16, 64: 16, 128: 1, 512: 1, 1024: 1}; sched.lod_training_kimg = 800; sched.lod_transition_kimg = 800; train.total_kimg = 19000
...
##desc += '-preset-v2-4gpus'; num_gpus = 4; sched.minibatch_base = 4; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 32, 64: 16, 128: 8, 512: 4, 1024: 16}; sched.G_lrate_dict = {256: 0.0015, 512: 0.002, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
