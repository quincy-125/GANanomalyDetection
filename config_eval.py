...
G_opt       = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-12) # Options for generator optimizer.
D_opt       = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-12) # Options for discriminator optimizer.
E_opt       = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-12) # Options for discriminator optimizer.
...
#desc += '-lsun-sofa';           dataset = EasyDict(tfrecord_dir='lsun-sofa-100k');           train.mirror_augment = TrueF
